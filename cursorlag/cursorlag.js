...
setInterval(function () {
  ...
  for (let i = 0; i < elements.length; i++) {
    if (elements[i].getAttribute("timecreated") < (Date.now() - 333/* Adjust this based on your CSS animation duration. (set this to the time until it disapears in ms plus a little extra.)*/)) {
      elements[i].remove();
      i--;
    }
  }
